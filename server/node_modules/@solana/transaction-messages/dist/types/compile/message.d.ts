 ...
 */
export declare function compileTransactionMessage<TTransactionMessage extends TransactionMessage & TransactionMessageWithFeePayer>(transactionMessage: TTransactionMessage): CompiledTransactionMessageFromTransactionMessage<TTransactionMessage>;
type CompiledTransactionMessageFromTransactionMessage<TTransactionMessage extends TransactionMessage> = ForwardTransactionMessageLifetime<ForwardTransactionMessageVersion<TTransactionMessage>, TTransactionMessage>;
type ForwardTransactionMessageVersion<TTransactionMessage extends TransactionMessage> = TTransactionMessage extends Readonly<{
    version: 'legacy';
